...
class Dev_edit_user extends CI_Controller {
    ...
    public function index($did, $Msg=0)
    {
        ...
        $this->load->view('dev_edit_user', $data);
    }
    ...
    public function update(){
        ...
        if($res != '-1'){
            redirect(base_url() . 'dev_find_user/G_128');
        }
        else{
            $did = strtr(base64_encode($res), '+/=', '._-');
            redirect(base_url() . 'dev_edit_user/code/'.$did.'/R_108');
        }
    }
}