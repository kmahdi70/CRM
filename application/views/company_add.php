                ...
                <div class="card-body Panel_Body">
                    ...
                    <div class="rtl">
                        <div class="row justify-content-between">
                            <div class="col-7 col-sm-4 col-md-3 col-lg-2 form-group text-right">
                            ...
                            <div class="col-7 col-sm-4 col-md-3 col-lg-2 form-group text-left">
                                <label for="acc_manager">Account Manager</label>
                                <select class="form-control" id="acc_manager">
                                    <option value="0">انتخاب اکانت منجر</option>
                                    <?php
                                    foreach ($AccManager as $row){
                                        ?>
