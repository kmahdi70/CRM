        ...
        <div class="col-12 text-center">
            <div class="card Form">
                <div class="card-header text-right Panel_Title">
                    <strong>مدیریت کاربران </strong><i class="far fa-folder-open Panel_Icon"></i>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header rtl">
                ...
                <h4 class="modal-title" style="">حذف کاربر</h4>
            </div>
            <div class="modal-body text-right">
                <p>آیا از پاک کردن کاربر اطمینان دارید؟</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">انصراف</button>
                <a class="btn btn-danger" id="DellUser">حذف</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    function ConfirmDelete(uid,tb){
        if(tb == 'admins')
            $('#DellUser').attr('href','<?php echo base_url().'user_find/dell_admin/'; ?>'+uid);
        if(tb == 'users')
            $('#DellUser').attr('href','<?php echo base_url().'user_find/dell_user/'; ?>'+uid);
    }

    $('#EditCompanyTB').DataTable( {
        "ajax":"<?php echo base_url().'user_find/user_list'; ?>",
