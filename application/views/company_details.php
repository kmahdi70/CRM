    ...
    <div class="row">
        <div class="col-12 text-center">
            <div class="card Form">
                ...
                <div class="card-body Panel_Body rtl text-right">
                    <div class="row rtl">
                        <div class="col-md-12 col-lg-3 form-group">
                            نام شرکت
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Name; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            شماره ثبت
                            <input type="number" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Register; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            نوع شرکت
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Type; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            برند
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Brand; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-3 form-group text-right">
                            مدیر عامل
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->CEO; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            همراه
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Mobile; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            تلفن
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Tell; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            فکس
                            <input type="text" class="form-control text-right rtl" autocomplete="off" value="<?php echo $Company->Fax; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-3 form-group text-right">
                            سایت
                            <input type="text" class="form-control text-left ltr" autocomplete="off" value="<?php echo $Company->Site; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-3 form-group text-right">
                            ایمیل
                            <input type="text" class="form-control text-left ltr" autocomplete="off" value="<?php echo $Company->Email; ?>" readonly>
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            دسته
                            <select class="form-control" disabled>
                                ...
                                foreach ($Category as $row){
                                    ?>
                                    <option <?php if($Company->Category_ID == $row->CID) echo 'selected'; ?>><?php echo $row->Title; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            ...
                            <select class="form-control" disabled>
                                ...
                                foreach ($SubCategory as $row){
                                    ?>
                                    <option <?php if($Company->SubCategory_ID == $row->SCID) echo 'selected'; ?>><?php echo $row->STitle; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md-12 col-lg-8 form-group text-right">
                            آدرس
                            <textarea cols="100%" class="form-control text-right rtl" readonly><?php echo $Company->Address; ?></textarea>
                            <!--<input type="text" style="text-wrap: none" class="form-control text-right rtl" autocomplete="off" value="<?php /*echo $Company->Address; */?>" placeholder="آدرس" readonly>-->
                        </div>
                    </div>
                    <!-- ******************************************************************************************************************** -->
                    ...
                    <div class="row rtl" id="Agents">
                        ...
                        <div class="col-md-12 col-lg-2 form-group text-right">
                            <input type="text" class="form-control text-right rtl" autocomplete="off" id="fax" name="fax" value="<?php echo set_value('fax'); ?>" placeholder="فکس">
                        </div>
                        <div class="col-md-12 col-lg-2 form-group text-right">
                    ...
                    foreach ($Agents as $row){
                        ...
                        <div class="row rtl" id="Agent_<?php echo $row->AID; ?>">
                            ...
                            <div class="col-md-12 col-lg-1 form-group" style="padding: 0;">
                                <a href="javascript:void(0);" class="text-primary fa-lg fa-fw"><i class="far fa-edit fa-2x fa-fw"></i></a>
                                <a href="javascript:void(0);" onclick="ConfirmDelete('<?php echo $row->AID; ?>');" data-toggle="modal" data-target="#ConfirmDell" class="text-danger fa-lg fa-fw"><i class="fas fa-trash-alt fa-2x fa-fw"></i></a>
...
<script>
    ...
    function AddAgent() {
        ...
        if(ln == ''){
            ...
            $.post(URL, {CID:cid, Add:add, FN:fn, LN:ln, Section:section, Post:post, Tell:tell, Mobile:mobile,Fax:fax, Email:email, SNID:snid}, function (res, ret) {
                if(ret == 'success'){
                    if(res != '-1'){
                        ...
                        $.get('<?php print(base_url().'htm/agent.html');?>', function(data) {
                            ...
                            $('#Agent_'+res+' #ADD').html('عنوان: '+add);
                            $('#Agent_'+res+' #FN').html('نام: '+fn);
                            $('#Agent_'+res+' #LN').html('نام خانوادگی: '+ln);
                            $('#Agent_'+res+' #Section').html('دپارتمان: '+section);
                            $('#Agent_'+res+' #Post').html('سمت: '+post);
                            $('#Agent_'+res+' #Tell').html('تلفن: '+tell);
                            $('#Agent_'+res+' #Fax').html('فکس: '+fax);
                            $('#Agent_'+res+' #Mobile').html('همراه: '+mobile);
                            $('#Agent_'+res+' #Email').html('ایمیل: '+email);
                            $('#Agent_'+res+' #SNID').html('توضیحات: '+snid);
